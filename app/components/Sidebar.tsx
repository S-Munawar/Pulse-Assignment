  ...
  return (
    ...
    >
      <div className="flex flex-col flex-1 my-5">
        ...
        <div className={`flex items-center pt-3 pb-2 ${collapsed ? "flex-col gap-2 px-2" : "justify-between px-3"}`}>
          ...
          >
            <svg
              ...
              className={`transition-transform duration-200 ${collapsed ? "scale-x-[-1]" : ""}`}
            >
        ...
        <nav className="flex flex-col gap-5 p-2 flex-1">
          ...
          <div className="flex flex-col gap-0.5">
            <Link href="/" title="Overview" className={`${linkBase} ${collapsed ? linkCollapsed : linkExpanded} ${isActive("/") ? "bg-sel" : ""}`}>
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
                <path d="M4.16632 9.82083C4.16632 8.68917 4.16632 8.12333 4.39465 7.62583C4.62382 7.12833 5.05299 6.76083 5.91215 6.02417L6.74549 5.31C8.29965 3.97917 9.07465 3.3125 9.99965 3.3125C10.9247 3.3125 11.7005 3.97833 13.2538 5.30917L14.0872 6.02333C14.9455 6.76 15.3755 7.1275 15.6038 7.625C15.833 8.1225 15.833 8.68833 15.833 9.82V13.3542C15.833 14.9258 15.833 15.7108 15.3447 16.1992C14.8563 16.6875 14.0713 16.6875 12.4997 16.6875H7.49965C5.92799 16.6875 5.14299 16.6875 4.65465 16.1992C4.16632 15.7108 4.16632 14.9258 4.16632 13.3542V9.82083Z" stroke={isActive("/") ? "#333333" : "#666666"} strokeWidth="1.5" />
                <path d="M12.083 16.6875V12.5208C12.083 12.2998 11.9952 12.0879 11.8389 11.9316C11.6826 11.7753 11.4707 11.6875 11.2497 11.6875H8.74965C8.52864 11.6875 8.31668 11.7753 8.1604 11.9316C8.00412 12.0879 7.91632 12.2998 7.91632 12.5208V16.6875" stroke={isActive("/") ? "#333333" : "#666666"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
          ...
          <div className="flex flex-col gap-0.5">
            ...
            <Link href="/features" title="Features" className={`${linkBase} ${collapsed ? linkCollapsed : linkExpanded} ${isActive("/features") ? "bg-sel" : ""}`}>
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
                <rect x="3.78235" y="3.29248" width="12.4352" height="13.415" rx="2.25" stroke={isActive("/features") ? "#333333" : "#666666"} strokeWidth="1.5" />
                <path d="M6.74631 7.31982H13.2542" stroke={isActive("/features") ? "#333333" : "#666666"} strokeWidth="1.5" strokeLinecap="round" />
                <path d="M6.74622 10.2261H9.992" stroke={isActive("/features") ? "#333333" : "#666666"} strokeWidth="1.5" strokeLinecap="round" />
              </svg>
          ...
          <div className="flex flex-col gap-0.5">
            ...
            <Link href="/customers" title="Customers" className={`${linkBase} ${collapsed ? linkCollapsed : linkExpanded} ${isActive("/customers") ? "bg-sel" : ""}`}>
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
                <path d="M13.9592 13.1271C13.9592 11.6687 12.1866 10.4874 9.99961 10.4874M9.99961 10.4874C7.81261 10.4874 6.04004 11.6687 6.04004 13.1271M9.99961 10.4874C9.29951 10.4874 8.62856 10.2093 8.13351 9.71428C7.63847 9.21924 7.36036 8.54782 7.36036 7.84772C7.36036 7.14763 7.63847 6.4762 8.13351 5.98116C8.62856 5.48612 9.29998 5.20801 10.0001 5.20801C10.7002 5.20801 11.3716 5.48612 11.8666 5.98116C12.3617 6.4762 12.6398 7.14763 12.6398 7.84772C12.6398 8.54782 12.3617 9.21924 11.8666 9.71428C11.3716 10.2093 10.6997 10.4874 9.99961 10.4874Z" stroke={isActive("/customers") ? "#333333" : "#666666"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M2.93945 6.92727V5.97314C2.93945 4.31629 4.2826 2.97314 5.93945 2.97314H7.19305" stroke={isActive("/customers") ? "#333333" : "#666666"} strokeWidth="1.5" strokeLinecap="round" />
                <path d="M6.89357 17.0811H5.93945C4.2826 17.0811 2.93945 15.7379 2.93945 14.0811L2.93945 12.8275" stroke={isActive("/customers") ? "#333333" : "#666666"} strokeWidth="1.5" strokeLinecap="round" />
                <path d="M17.0146 13.1269V14.0811C17.0146 15.7379 15.6715 17.0811 14.0146 17.0811H12.7611" stroke={isActive("/customers") ? "#333333" : "#666666"} strokeWidth="1.5" strokeLinecap="round" />
                <path d="M13.0605 2.89014L14.0147 2.89014C15.6715 2.89014 17.0146 4.23328 17.0146 5.89014V7.14373" stroke={isActive("/customers") ? "#333333" : "#666666"} strokeWidth="1.5" strokeLinecap="round" />
              </svg>
        ...
        {/* Footer */}
        <div className={`pb-6 flex items-center ${collapsed ? "flex-col gap-2 px-2" : "justify-between px-3"}`}>
          <button
            title="Octane.io"
          ...
          >
            <div className="w-6 h-6 rounded-full bg-[#DD5263] text-white text-xs font-semibold flex items-center justify-center flex-shrink-0">O</div>
            {!collapsed && (
              <>
                <span className="text-sm text-t1 whitespace-nowrap">Octane.io</span>
